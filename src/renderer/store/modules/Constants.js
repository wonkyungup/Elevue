...
const state = {
    ...
    ICON_ARROW_COLLAPSE_LEFT: Defs.ICON_ARROW_COLLAPSE_LEFT,
    ...
    ICON_ALERT_CIRCLE: Defs.ICON_ALERT_CIRCLE,
    ICON_PLAY: Defs.ICON_PLAY,
    ICON_STOP: Defs.ICON_STOP,
    ICON_TRASH: Defs.ICON_TRASH,
    ICON_TEXT: Defs.ICON_TEXT,
    ICON_CHECK: Defs.ICON_CHECK,
    ...
    STR_DISPLAY_XS: Defs.STR_DISPLAY_XS,
    STR_DISPLAY_SM: Defs.STR_DISPLAY_SM,
    STR_DISPLAY_MD: Defs.STR_DISPLAY_MD,
    STR_DISPLAY_LG: Defs.STR_DISPLAY_LG,
    STR_DISPLAY_XL: Defs.STR_DISPLAY_XL,
    STR_TYPE_SUCCESS: Defs.STR_TYPE_SUCCESS,
    STR_TYPE_WARNING: Defs.STR_TYPE_WARNING,
    STR_TYPE_ERROR: Defs.STR_TYPE_ERROR,
    STR_TYPE_INFO: Defs.STR_TYPE_INFO,
